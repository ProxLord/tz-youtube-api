package com.tz.youtuberoom.ui.video
...
import com.tz.youtuberoom.R
import com.tz.youtuberoom.adapter.VideoAdapter
import com.tz.youtuberoom.databinding.FragmentVideoBinding
...
class VideoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        videoViewModel?.isAllVideoLoaded?.observe(viewLifecycleOwner, {
            isAllVideoLoaded = it
            if (it) Toast.makeText(requireContext(), "Поиск завершен!!", Toast.LENGTH_SHORT).show()
        })
